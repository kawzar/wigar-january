...
function preload() {
    ...
    var appearEffectSheet = loadSpriteSheet(
        ASSETS_FOLDER + "appearEffect.png",
        10,
        18,
        10
    );
    ...
    var disappearEffectSheet = loadSpriteSheet(
        ASSETS_FOLDER + "disappearEffect.png",
        10,
        18,
        10
    );
...
function isObstacle(x, y, room, a) {
    ...
    if (room != null && a != null) {
        ...
        if (c1[0] != 255 || c1[1] != 255 || c1[2] != 255) {
            ...
            if (cmd != null)
                if (cmd.obstacle != null) obs = cmd.obstacle;
...
function canvasReleased() {
    ...
    if (screen == "error") {} else if (nickName != "" && screen == "game" && mouseButton == RIGHT) {
        if (me.destinationX == me.x && me.destinationY == me.y)
            socket.emit("emote", { room: me.room, em: false });
