...
module.exports.IMAGES = [["logo", "LogoEvento.png"]];
  ...
  patio: {
    ...
    things: {
      ...
      harvey: {
        ...
        position: [101, 81],
        label: "Harvey",
        command: { cmd: "text", txt: "*Acaricias al perrito*", align: "center", lines: 1, point: [101, 84] },
      },
      cat: {
      ...
      unicorn: {
        ...
        position: [79, 42],
        label: "Unicornio",
        command: { cmd: "text", txt: "Pride Rainbow Dash", align: "center", lines: 1, point: [80, 63] },
      },
      flowers: {
        ...
        position: [112, 38],
        label: "Florcitas",
        command: { cmd: "text", txt: "Son muy lindas!", align: "center", lines: 1, point: [108, 47] },
      },
      fox: {
        file: "Fox.png",
        frames: 2,
      ...
      pinkDrink: {
        ...
        position: [59, 69],
        label: "Trago Loco",
        command: { cmd: "action", actionId: "DrinkInteract" },
      },
      orangeDrink: {
        ...
        position: [71, 71],
        label: "Trago naranja",
        command: { cmd: "action", actionId: "GibberishInteracted" },
      },
